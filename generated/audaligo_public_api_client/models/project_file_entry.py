...
T = TypeVar("T", bound="ProjectFileEntry")
...
class ProjectFileEntry:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        kind = ProjectFileEntryKind(d.pop("kind"))
        ...
        file = ProjectFile.from_dict(d.pop("file"))

        project_file_entry = cls(
            kind=kind,
            id=id,
