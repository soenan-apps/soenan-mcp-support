...
from ...models.publish_project_stage_request import PublishProjectStageRequest
from ...models.publish_project_stage_sec_fetch_site import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/projects/{project}/stages/{stage}/publish".format(
