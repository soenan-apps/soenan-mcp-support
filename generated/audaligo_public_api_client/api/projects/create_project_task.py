...
from ...models.create_project_task_sec_fetch_site import CreateProjectTaskSecFetchSite
from ...models.error_envelope import ErrorEnvelope
from ...models.project_task_response import ProjectTaskResponse
from ...models.project_task_values_request import ProjectTaskValuesRequest
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ProjectTaskResponse.from_dict(response.json())
