...
from ...models.delete_chat_message_request import DeleteChatMessageRequest
from ...models.delete_project_chat_message_sec_fetch_site import DeleteProjectChatMessageSecFetchSite
...
def _get_kwargs(
    ...
    *,
    ...
    origin: str,
    sec_fetch_site: DeleteProjectChatMessageSecFetchSite | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        message (str):
        origin (str):
        sec_fetch_site (DeleteProjectChatMessageSecFetchSite | Unset):
        body (DeleteChatMessageRequest):
